...
class CRCommodity: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
                ...
                dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0)){
                    self.connect(URL+"/grabcommodityrecords/list")
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        if(GrabCommodity!.items[indexPath.row].islotteried==1){
            ...
            another.Id=Int(GrabCommodity!.items[indexPath.row].grabcommodityid!)!
            ...
            anotherView.GrabCommodityId=Int(GrabCommodity!.items[indexPath.row].grabcommodityid!)!
