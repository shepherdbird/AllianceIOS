...
@interface MainViewController () <UIAlertViewDelegate, IChatManagerDelegate>
{
    ...
    ResourceController *_resourceVC;
    Me *_meVC;
...
- (void)setupSubviews
{
    ...
    _resourceVC = [[ResourceController alloc] initWithNibName:nil bundle:nil];
    ...
    self.viewControllers = @[_chatListVC, _contactsVC,_resourceVC,_meVC];
    [self selectedTapTabBarItems:_chatListVC.tabBarItem];
}
