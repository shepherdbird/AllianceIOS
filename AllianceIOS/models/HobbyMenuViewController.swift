//
//  HobbyMenuViewController.swift
//  AllianceIOS
//
//  Created by xufei on 15/11/29.
//
//
...
class HobbyMenuViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        if(indexPath.row==0){
            ...
            let myStoryBoard = UIStoryboard(name: "Main", bundle: nil)
            let anotherView:UIViewController=myStoryBoard.instantiateViewControllerWithIdentifier("HobbyMy");
            Spec?.navigationController?.pushViewController(anotherView, animated: true)
        }
