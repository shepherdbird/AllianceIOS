...
class JobproViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        if let game = selected {
            selectedIndex = pro.indexOf(game)
        }
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = pro[indexPath.row]
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        if(flag==0)
        {
            Jobreq?.Prop.text = self.pro[indexPath.row]
        }else{
            Jobsearch?.Pro.text=self.pro[indexPath.row]
        }
